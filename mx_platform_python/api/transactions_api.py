...
class TransactionsApi:
    ...
    @validate_arguments
    def users_user_guid_accounts_account_guid_transactions_post(self, user_guid : Annotated[StrictStr, Field(..., description="The unique identifier for the user.")], account_guid : Annotated[StrictStr, Field(..., description="The unique identifier for the account.")], transaction_create_request_body : TransactionCreateRequestBody, **kwargs) -> TransactionCreateResponseBody:  # noqa: E501
        ...
        >>> thread = api.users_user_guid_accounts_account_guid_transactions_post(user_guid, account_guid, transaction_create_request_body, async_req=True)
        >>> result = thread.get()

        :param user_guid: The unique identifier for the user. (required)
        :type user_guid: str
        :param account_guid: The unique identifier for the account. (required)
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the users_user_guid_accounts_account_guid_transactions_post_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.users_user_guid_accounts_account_guid_transactions_post_with_http_info(user_guid, account_guid, transaction_create_request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def users_user_guid_accounts_account_guid_transactions_post_with_http_info(self, user_guid : Annotated[StrictStr, Field(..., description="The unique identifier for the user.")], account_guid : Annotated[StrictStr, Field(..., description="The unique identifier for the account.")], transaction_create_request_body : TransactionCreateRequestBody, **kwargs) -> ApiResponse:  # noqa: E501
        """Create manual transaction  # noqa: E501
        ...
        >>> thread = api.users_user_guid_accounts_account_guid_transactions_post_with_http_info(user_guid, account_guid, transaction_create_request_body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method users_user_guid_accounts_account_guid_transactions_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
