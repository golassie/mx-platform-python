...
class RepositionRequestBody(BaseModel):
    ...
    """
    goals: Optional[conlist(RepositionRequest)] = None
    __properties = ["goals"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RepositionRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RepositionRequestBody:
        """Create an instance of RepositionRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RepositionRequestBody.parse_obj(obj)

        _obj = RepositionRequestBody.parse_obj({
            "goals": [RepositionRequest.from_dict(_item) for _item in obj.get("goals")] if obj.get("goals") is not None else None
        })
        return _obj
