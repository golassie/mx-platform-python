...
class MonthlyCashFlowProfileRequestBody(BaseModel):
    ...
    """
    institution: Optional[MonthlyCashFlowProfileRequest] = None
    __properties = ["institution"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonthlyCashFlowProfileRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonthlyCashFlowProfileRequestBody:
        """Create an instance of MonthlyCashFlowProfileRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonthlyCashFlowProfileRequestBody.parse_obj(obj)

        _obj = MonthlyCashFlowProfileRequestBody.parse_obj({
            "institution": MonthlyCashFlowProfileRequest.from_dict(obj.get("institution")) if obj.get("institution") is not None else None
        })
        return _obj
