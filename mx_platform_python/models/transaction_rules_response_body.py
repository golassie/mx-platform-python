...
class TransactionRulesResponseBody(BaseModel):
    ...
    transaction_rules: Optional[conlist(TransactionRuleResponse)] = None
    __properties = ["pagination", "transaction_rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRulesResponseBody:
    ...
    def to_dict(self):
        ...
        if self.transaction_rules:
            ...
            _dict['transaction_rules'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRulesResponseBody:
        """Create an instance of TransactionRulesResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRulesResponseBody.parse_obj(obj)

        _obj = TransactionRulesResponseBody.parse_obj({
            "pagination": PaginationResponse.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "transaction_rules": [TransactionRuleResponse.from_dict(_item) for _item in obj.get("transaction_rules")] if obj.get("transaction_rules") is not None else None
        })
        return _obj
