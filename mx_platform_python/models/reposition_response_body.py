...
class RepositionResponseBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RepositionResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RepositionResponseBody:
        """Create an instance of RepositionResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RepositionResponseBody.parse_obj(obj)

        _obj = RepositionResponseBody.parse_obj({
