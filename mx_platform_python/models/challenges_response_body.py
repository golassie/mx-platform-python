...
class ChallengesResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChallengesResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChallengesResponseBody:
        """Create an instance of ChallengesResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChallengesResponseBody.parse_obj(obj)

        _obj = ChallengesResponseBody.parse_obj({
