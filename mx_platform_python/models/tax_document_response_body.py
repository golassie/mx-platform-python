...
class TaxDocumentResponseBody(BaseModel):
    ...
    """
    tax_document: Optional[TaxDocumentResponse] = None
    __properties = ["tax_document"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaxDocumentResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaxDocumentResponseBody:
        """Create an instance of TaxDocumentResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaxDocumentResponseBody.parse_obj(obj)

        _obj = TaxDocumentResponseBody.parse_obj({
            "tax_document": TaxDocumentResponse.from_dict(obj.get("tax_document")) if obj.get("tax_document") is not None else None
        })
        return _obj
