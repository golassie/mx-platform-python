...
class TagResponseBody(BaseModel):
    """
    TagResponseBody
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagResponseBody:
        """Create an instance of TagResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagResponseBody.parse_obj(obj)

        _obj = TagResponseBody.parse_obj({
            "tag": TagResponse.from_dict(obj.get("tag")) if obj.get("tag") is not None else None
        })
        return _obj
