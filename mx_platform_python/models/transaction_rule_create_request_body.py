...
class TransactionRuleCreateRequestBody(BaseModel):
    ...
    """
    transaction_rule: Optional[TransactionRuleCreateRequest] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRuleCreateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRuleCreateRequestBody:
        """Create an instance of TransactionRuleCreateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRuleCreateRequestBody.parse_obj(obj)

        _obj = TransactionRuleCreateRequestBody.parse_obj({
            "transaction_rule": TransactionRuleCreateRequest.from_dict(obj.get("transaction_rule")) if obj.get("transaction_rule") is not None else None
        })
        return _obj
