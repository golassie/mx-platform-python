...
class CategoriesResponseBody(BaseModel):
    """
    CategoriesResponseBody
    """
    categories: Optional[conlist(CategoryResponse)] = None
    pagination: Optional[PaginationResponse] = None
    __properties = ["categories", "pagination"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CategoriesResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CategoriesResponseBody:
        """Create an instance of CategoriesResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CategoriesResponseBody.parse_obj(obj)

        _obj = CategoriesResponseBody.parse_obj({
            "categories": [CategoryResponse.from_dict(_item) for _item in obj.get("categories")] if obj.get("categories") is not None else None,
