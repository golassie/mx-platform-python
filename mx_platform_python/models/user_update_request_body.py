...
class UserUpdateRequestBody(BaseModel):
    ...
    """
    user: Optional[UserUpdateRequest] = None
    __properties = ["user"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserUpdateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserUpdateRequestBody:
        """Create an instance of UserUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserUpdateRequestBody.parse_obj(obj)

        _obj = UserUpdateRequestBody.parse_obj({
            "user": UserUpdateRequest.from_dict(obj.get("user")) if obj.get("user") is not None else None
        })
        return _obj
