...
class ManagedTransactionCreateRequestBody(BaseModel):
    ...
    """
    transaction: Optional[ManagedTransactionCreateRequest] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagedTransactionCreateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManagedTransactionCreateRequestBody:
        """Create an instance of ManagedTransactionCreateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagedTransactionCreateRequestBody.parse_obj(obj)

        _obj = ManagedTransactionCreateRequestBody.parse_obj({
            "transaction": ManagedTransactionCreateRequest.from_dict(obj.get("transaction")) if obj.get("transaction") is not None else None
        })
        return _obj
