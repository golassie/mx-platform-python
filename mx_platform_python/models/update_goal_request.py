...
class UpdateGoalRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateGoalRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateGoalRequest:
        """Create an instance of UpdateGoalRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateGoalRequest.parse_obj(obj)

        _obj = UpdateGoalRequest.parse_obj({
