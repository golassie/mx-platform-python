...
class AccountResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountResponseBody:
        """Create an instance of AccountResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountResponseBody.parse_obj(obj)

        _obj = AccountResponseBody.parse_obj({
            "account": AccountResponse.from_dict(obj.get("account")) if obj.get("account") is not None else None
        })
        return _obj
