...
class TransactionRuleResponseBody(BaseModel):
    ...
    """
    transaction_rule: Optional[TransactionRuleResponse] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRuleResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRuleResponseBody:
        """Create an instance of TransactionRuleResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRuleResponseBody.parse_obj(obj)

        _obj = TransactionRuleResponseBody.parse_obj({
            "transaction_rule": TransactionRuleResponse.from_dict(obj.get("transaction_rule")) if obj.get("transaction_rule") is not None else None
        })
        return _obj
