...
class PaymentProcessorAuthorizationCodeResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentProcessorAuthorizationCodeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentProcessorAuthorizationCodeResponse:
        """Create an instance of PaymentProcessorAuthorizationCodeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentProcessorAuthorizationCodeResponse.parse_obj(obj)

        _obj = PaymentProcessorAuthorizationCodeResponse.parse_obj({
