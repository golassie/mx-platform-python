...
class UserCreateRequestBody(BaseModel):
    ...
    """
    user: Optional[UserCreateRequest] = None
    __properties = ["user"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserCreateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserCreateRequestBody:
        """Create an instance of UserCreateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserCreateRequestBody.parse_obj(obj)

        _obj = UserCreateRequestBody.parse_obj({
            "user": UserCreateRequest.from_dict(obj.get("user")) if obj.get("user") is not None else None
        })
        return _obj
