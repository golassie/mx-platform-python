...
class MicrodepositsResponseBody(BaseModel):
    """
    MicrodepositsResponseBody
    """
    micro_deposits: Optional[conlist(MicrodepositResponse)] = None
    pagination: Optional[PaginationResponse] = None
    __properties = ["micro_deposits", "pagination"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MicrodepositsResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MicrodepositsResponseBody:
        """Create an instance of MicrodepositsResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MicrodepositsResponseBody.parse_obj(obj)

        _obj = MicrodepositsResponseBody.parse_obj({
            "micro_deposits": [MicrodepositResponse.from_dict(_item) for _item in obj.get("micro_deposits")] if obj.get("micro_deposits") is not None else None,
