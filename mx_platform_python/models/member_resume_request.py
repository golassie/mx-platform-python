...
class MemberResumeRequest(BaseModel):
    ...
    MemberResumeRequest
    """
    challenges: Optional[conlist(CredentialRequest)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberResumeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MemberResumeRequest:
        """Create an instance of MemberResumeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberResumeRequest.parse_obj(obj)

        _obj = MemberResumeRequest.parse_obj({
            "challenges": [CredentialRequest.from_dict(_item) for _item in obj.get("challenges")] if obj.get("challenges") is not None else None
        })
        return _obj
