...
class SplitTransactionRequestBody(BaseModel):
    ...
    """
    transactions: SplitTransactionRequest = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SplitTransactionRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SplitTransactionRequestBody:
        """Create an instance of SplitTransactionRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SplitTransactionRequestBody.parse_obj(obj)

        _obj = SplitTransactionRequestBody.parse_obj({
            "transactions": SplitTransactionRequest.from_dict(obj.get("transactions")) if obj.get("transactions") is not None else None
        })
        return _obj
