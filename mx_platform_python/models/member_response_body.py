...
class MemberResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MemberResponseBody:
        """Create an instance of MemberResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberResponseBody.parse_obj(obj)

        _obj = MemberResponseBody.parse_obj({
            "member": MemberResponse.from_dict(obj.get("member")) if obj.get("member") is not None else None
        })
        return _obj
