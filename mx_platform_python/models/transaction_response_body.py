...
class TransactionResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionResponseBody:
        """Create an instance of TransactionResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionResponseBody.parse_obj(obj)

        _obj = TransactionResponseBody.parse_obj({
            "transaction": TransactionResponse.from_dict(obj.get("transaction")) if obj.get("transaction") is not None else None
        })
        return _obj
