...
class SpendingPlansResponseBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpendingPlansResponseBody:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic.v1 by calling `to_dict()` of each item in spending_plans (list)
        _items = []
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpendingPlansResponseBody:
