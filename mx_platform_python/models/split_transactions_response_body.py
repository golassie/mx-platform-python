...
class SplitTransactionsResponseBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SplitTransactionsResponseBody:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic.v1 by calling `to_dict()` of each item in transactions (list)
        _items = []
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SplitTransactionsResponseBody:
        """Create an instance of SplitTransactionsResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SplitTransactionsResponseBody.parse_obj(obj)

        _obj = SplitTransactionsResponseBody.parse_obj({
