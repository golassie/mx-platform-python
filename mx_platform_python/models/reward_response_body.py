...
class RewardResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RewardResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RewardResponseBody:
        """Create an instance of RewardResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RewardResponseBody.parse_obj(obj)

        _obj = RewardResponseBody.parse_obj({
            "reward": RewardResponse.from_dict(obj.get("reward")) if obj.get("reward") is not None else None
        })
        return _obj
