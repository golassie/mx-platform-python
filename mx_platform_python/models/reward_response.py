...
class RewardResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RewardResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RewardResponse:
        """Create an instance of RewardResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RewardResponse.parse_obj(obj)

        _obj = RewardResponse.parse_obj({
