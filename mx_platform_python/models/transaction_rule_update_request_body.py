...
class TransactionRuleUpdateRequestBody(BaseModel):
    ...
    """
    transaction_rule: Optional[TransactionRuleUpdateRequest] = None
    __properties = ["transaction_rule"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRuleUpdateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRuleUpdateRequestBody:
        """Create an instance of TransactionRuleUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRuleUpdateRequestBody.parse_obj(obj)

        _obj = TransactionRuleUpdateRequestBody.parse_obj({
            "transaction_rule": TransactionRuleUpdateRequest.from_dict(obj.get("transaction_rule")) if obj.get("transaction_rule") is not None else None
        })
        return _obj
