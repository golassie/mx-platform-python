...
class OAuthWindowResponseBody(BaseModel):
    ...
    """
    member: Optional[OAuthWindowResponse] = None
    __properties = ["member"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OAuthWindowResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OAuthWindowResponseBody:
        """Create an instance of OAuthWindowResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OAuthWindowResponseBody.parse_obj(obj)

        _obj = OAuthWindowResponseBody.parse_obj({
            "member": OAuthWindowResponse.from_dict(obj.get("member")) if obj.get("member") is not None else None
        })
        return _obj
