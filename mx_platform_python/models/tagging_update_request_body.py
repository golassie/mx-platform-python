...
class TaggingUpdateRequestBody(BaseModel):
    ...
    """
    tagging: Optional[TaggingUpdateRequest] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaggingUpdateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaggingUpdateRequestBody:
        """Create an instance of TaggingUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaggingUpdateRequestBody.parse_obj(obj)

        _obj = TaggingUpdateRequestBody.parse_obj({
            "tagging": TaggingUpdateRequest.from_dict(obj.get("tagging")) if obj.get("tagging") is not None else None
        })
        return _obj
