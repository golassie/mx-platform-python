...
class AccountNumbersResponseBody(BaseModel):
    ...
    """
    account_numbers: Optional[conlist(AccountNumberResponse)] = None
    pagination: Optional[PaginationResponse] = None
    __properties = ["account_numbers", "pagination"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountNumbersResponseBody:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic.v1 by calling `to_dict()` of each item in account_numbers (list)
        _items = []
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountNumbersResponseBody:
        """Create an instance of AccountNumbersResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountNumbersResponseBody.parse_obj(obj)

        _obj = AccountNumbersResponseBody.parse_obj({
            "account_numbers": [AccountNumberResponse.from_dict(_item) for _item in obj.get("account_numbers")] if obj.get("account_numbers") is not None else None,
