...
class ManagedMemberUpdateRequestBody(BaseModel):
    ...
    """
    member: Optional[ManagedMemberUpdateRequest] = None
    __properties = ["member"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagedMemberUpdateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManagedMemberUpdateRequestBody:
        """Create an instance of ManagedMemberUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagedMemberUpdateRequestBody.parse_obj(obj)

        _obj = ManagedMemberUpdateRequestBody.parse_obj({
            "member": ManagedMemberUpdateRequest.from_dict(obj.get("member")) if obj.get("member") is not None else None
        })
        return _obj
