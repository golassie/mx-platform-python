...
class MerchantLocationResponseBody(BaseModel):
    ...
    """
    merchant_location: Optional[MerchantLocationResponse] = None
    __properties = ["merchant_location"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MerchantLocationResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MerchantLocationResponseBody:
        """Create an instance of MerchantLocationResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MerchantLocationResponseBody.parse_obj(obj)

        _obj = MerchantLocationResponseBody.parse_obj({
            "merchant_location": MerchantLocationResponse.from_dict(obj.get("merchant_location")) if obj.get("merchant_location") is not None else None
        })
        return _obj
