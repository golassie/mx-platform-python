...
class ManagedAccountCreateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagedAccountCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManagedAccountCreateRequest:
        """Create an instance of ManagedAccountCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagedAccountCreateRequest.parse_obj(obj)

        _obj = ManagedAccountCreateRequest.parse_obj({
