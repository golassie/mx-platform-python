...
class UserResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserResponseBody:
        """Create an instance of UserResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserResponseBody.parse_obj(obj)

        _obj = UserResponseBody.parse_obj({
