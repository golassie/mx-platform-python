...
class ManagedTransactionUpdateRequestBody(BaseModel):
    ...
    """
    transaction: Optional[ManagedTransactionUpdateRequest] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagedTransactionUpdateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManagedTransactionUpdateRequestBody:
        """Create an instance of ManagedTransactionUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagedTransactionUpdateRequestBody.parse_obj(obj)

        _obj = ManagedTransactionUpdateRequestBody.parse_obj({
            "transaction": ManagedTransactionUpdateRequest.from_dict(obj.get("transaction")) if obj.get("transaction") is not None else None
        })
        return _obj
