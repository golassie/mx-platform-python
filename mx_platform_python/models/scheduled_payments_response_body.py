...
class ScheduledPaymentsResponseBody(BaseModel):
    ...
    scheduled_payments: Optional[conlist(ScheduledPaymentResponse)] = None
    __properties = ["pagination", "scheduled_payments"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScheduledPaymentsResponseBody:
    ...
    def to_dict(self):
        ...
        if self.scheduled_payments:
            ...
            _dict['scheduled_payments'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ScheduledPaymentsResponseBody:
        """Create an instance of ScheduledPaymentsResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScheduledPaymentsResponseBody.parse_obj(obj)

        _obj = ScheduledPaymentsResponseBody.parse_obj({
            "pagination": PaginationResponse.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "scheduled_payments": [ScheduledPaymentResponse.from_dict(_item) for _item in obj.get("scheduled_payments")] if obj.get("scheduled_payments") is not None else None
        })
        return _obj
