...
class ManagedMemberUpdateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagedMemberUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManagedMemberUpdateRequest:
        """Create an instance of ManagedMemberUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagedMemberUpdateRequest.parse_obj(obj)

        _obj = ManagedMemberUpdateRequest.parse_obj({
            "id": obj.get("id"),
