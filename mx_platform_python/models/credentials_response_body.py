...
class CredentialsResponseBody(BaseModel):
    """
    CredentialsResponseBody
    """
    credentials: Optional[conlist(CredentialResponse)] = None
    pagination: Optional[PaginationResponse] = None
    __properties = ["credentials", "pagination"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CredentialsResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CredentialsResponseBody:
        """Create an instance of CredentialsResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CredentialsResponseBody.parse_obj(obj)

        _obj = CredentialsResponseBody.parse_obj({
            "credentials": [CredentialResponse.from_dict(_item) for _item in obj.get("credentials")] if obj.get("credentials") is not None else None,
