...
class InsightUpdateRequest(BaseModel):
    ...
    __properties = ["has_been_displayed", "is_dismissed"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightUpdateRequest:
        """Create an instance of InsightUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightUpdateRequest.parse_obj(obj)

        _obj = InsightUpdateRequest.parse_obj({
