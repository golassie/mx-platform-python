...
class UserUpdateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserUpdateRequest:
        """Create an instance of UserUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserUpdateRequest.parse_obj(obj)

        _obj = UserUpdateRequest.parse_obj({
            "email": obj.get("email"),
            "id": obj.get("id"),
