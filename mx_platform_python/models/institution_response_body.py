...
class InstitutionResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstitutionResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstitutionResponseBody:
        """Create an instance of InstitutionResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstitutionResponseBody.parse_obj(obj)

        _obj = InstitutionResponseBody.parse_obj({
            "institution": InstitutionResponse.from_dict(obj.get("institution")) if obj.get("institution") is not None else None
        })
        return _obj
